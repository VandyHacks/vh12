...
const day1Items: ModuleType[] = [
    ...
    { time: "2:00 PM", name: "VandyHacks Workshop 1: Intro to Prompt Engineering"},
    { time: "3:00 PM", name: "MLH Workshop 2: Intro to Google AI Studio" },
    { time: "4:00 PM", name: "Social Event 1: Tech Together MeetUp" },
    { time: "5:30 PM", name: "VandyHacks Workshop 2: OpenClaw" },
